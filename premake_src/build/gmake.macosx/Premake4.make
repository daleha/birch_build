...
ifeq ($(config),releaseuniv32)
  ...
  CFLAGS    += $(CPPFLAGS) $(ARCH) -Wall -Os -arch i386 -arch ppc -mmacosx-version-min=10.4
  CXXFLAGS  += $(CFLAGS) 
  LDFLAGS   += -Wl,-x -arch i386 -arch ppc -mmacosx-version-min=10.4
  LIBS      += -framework CoreServices
  RESFLAGS  += $(DEFINES) $(INCLUDES) 
  LDDEPS    += 
  LINKCMD    = $(CC) -o $(TARGET) $(OBJECTS) $(LDFLAGS) $(RESOURCES) $(ARCH) $(LIBS)
...
ifeq ($(config),debuguniv32)
  ...
  INCLUDES  += -I../../src/host/lua-5.1.4/src
  CPPFLAGS  +=  $(DEFINES) $(INCLUDES)
  CFLAGS    += $(CPPFLAGS) $(ARCH) -Wall -g -arch i386 -arch ppc -mmacosx-version-min=10.4
  CXXFLAGS  += $(CFLAGS) 
